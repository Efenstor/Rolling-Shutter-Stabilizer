...
JelloComplex1::JelloComplex1(TransformationMem *tm){
    AssignShiftMem(tm);
}

JelloComplex1::JelloComplex1(Mat img1, Mat img2, int index0, int index1, TransformationMem *tm)
{
    AssignShiftMem(tm);
...
/* *** Test constructor ***    */
JelloComplex1::JelloComplex1(vector<Point2f> corners1, vector<Point2f> corners2, int length, TransformationMem *tm)
{
    AssignShiftMem(tm);
...
void JelloComplex1::AssignShiftMem(TransformationMem *tm)
{
    params = tm->params;
    shiftsX = tm->shiftsX;
    shiftsY = tm->shiftsY;
...
void JelloComplex1::CreateAbsoluteTransformThread(TransformationMem *prevMem, TransformationMem *newMem,
...
void JelloComplex1::CreateAbsoluteTransform(TransformationMem *prevMem, TransformationMem *newMem)
{
    ...
    for(int t=0; t<tNum; t++)
    {
        std::thread newThr(&JelloComplex1::CreateAbsoluteTransformThread, this, prevMem, newMem,
